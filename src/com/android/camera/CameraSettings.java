...
public class CameraSettings {
    ...
    public static final String KEY_ULTRAPIXEL = "pref_camera_ultrapixel_key";
    ...
    private void initPreference(PreferenceGroup group) {
        ...
        ListPreference touchTo = group.findPreference(KEY_TOUCH_TO);
        ListPreference volumeButtons = group.findPreference(KEY_VOLUME_BUTTONS);
